...
import { DESTROY_PROGRAMMING_LANGUAGE } from '../../../../services/Mutations/ProgrammingLanguageMutation';

export const ListLanguage =(props)=> {
    const [showModal, setShowModal] = useState(false);
    const [deleteLanguage] = useMutation(DESTROY_PROGRAMMING_LANGUAGE, {
      onCompleted: ()=>{
          window.location.href = '/language_programmation';
      }
    })
  ...
  return (
    <>
      <tr>
        ...
        <td className='block m-auto md:space-x-4 px-5 py-5 border-b border-gray-200 bg-white text-sm'>
