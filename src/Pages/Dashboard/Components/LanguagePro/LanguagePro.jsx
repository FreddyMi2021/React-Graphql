...
const LanguagePro = (props) => {
    return(
        <>
            <Link to='/language_programmation' className="w-full h-28 flex bg-green-500 rounded-sm shadow-md">
                <div className="flex rounded-l-md items-center bg-green-500 justify-center flex-shrink-0 top-0 bottom-o left-0 w-20 h-28 text-red-500">
                    <AiOutlineCode className="text-white" size="4rem"/>
                </div>
                <div className="w-full bg-green-500 z-0 rounded-r-md border-l-2 border-gray-50 flex-grow p-2">
                    ...
                    <div className="mx-auto">
                        ...
                        {props.listLanguage.length < 10 ? '0'+props.listLanguage.length : props.listLanguage.length}
                        </div>
                    </div>
                </div>
            </Link>
