...
import { DESTROY_FRAMEWORK } from '../../../../services/Mutations/FrameworkMutation';

export const ListFramework =(props)=> {
    const [showModal, setShowModal] = useState(false);

    const [deleteFram] = useMutation(DESTROY_FRAMEWORK, {
      onCompleted: ()=> {
...
<tr key={props.id}>
        ...
        <td className='px-5 py-5 border-b border-gray-200 bg-white text-sm'>
          <p className='text-gray-900 whitespace-no-wrap'>{props.language.name}</p>
        </td>
