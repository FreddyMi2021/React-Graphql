...
import { DESTROY_DEPENDENCY } from '../../../../services/Mutations/DependanciesMutation';
export const ListDependancy = (props) => {
    const [showModal, setShowModal] = useState(false);
    const [deleteDependancy] = useMutation(DESTROY_DEPENDENCY, {
        onCompleted: () => {
            window.location.href = '/dependance';
        }
    })
    ...
    return(
        <>
            <tr key={props.id}>
                ...
                <td className='px-5 py-5 border-b border-gray-200 bg-white text-sm'>
                    <p className='text-gray-900 whitespace-no-wrap'>{props.cmd}</p>
                </td>
                <td className='px-5 py-5 border-b border-gray-200 bg-white text-sm'>
                    <p className='text-gray-900 whitespace-no-wrap'>{props.description}</p>
                </td>
                <td className='px-5 py-5 border-b border-gray-200 bg-white text-sm'>
                    <p className='text-gray-900 whitespace-no-wrap'>{props.framework}</p>
                </td>
                <td className='px-5 py-5 border-b border-gray-200 bg-white text-sm'>
                    <p className='text-gray-900 whitespace-no-wrap'>{props.cms}</p>
                </td>
